...
class Gift
{
    ...
    public static void backTracking(int x, int y) {
        ...
        for(int i = 0; i<4; i++) {
            ...
            if(isAvailable(newX, newY, colLen, rowLen) && !visited[newY][newX] && !set.contains(map[newY][newX])) {
    ...
    public static boolean isAvailable(int x, int y, int colLen, int rowLen) {
